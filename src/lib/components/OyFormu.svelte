...
{#if !secilen}
  ...
  <div style="display: flex; align-items: center; gap: 10px; margin-top: 28px; padding-top: 22px; border-top: 1px solid oklch(0.28 0.02 265); font-family: 'JetBrains Mono', monospace; font-size: 12px; color: oklch(0.6 0.01 260);">
    <span style="text-transform: uppercase; letter-spacing: 0.08em;">Sıradaki oylamaya kalan</span>
...
{:else}
      ...
      <div>
        <div style="display: flex; justify-content: space-between; align-items: baseline; margin-bottom: 9px;">
          <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
            ...
            {#if r.isChoice}
              <span style="font-family: 'JetBrains Mono', monospace; font-size: 10px; letter-spacing: 0.1em; text-transform: uppercase; color: {LIME}; border: 1px solid oklch(0.5 0.12 145); border-radius: 999px; padding: 2px 8px; white-space: nowrap;">Senin oyun</span>
            {/if}
          </div>
        ...
        <div style="margin-top: 7px; font-family: 'JetBrains Mono', monospace; font-size: 11px; color: oklch(0.6 0.01 260);">{formatN(r.votes)} oy</div>
      </div>
    {/each}
  </div>
  ...
  <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-top: 30px; padding-top: 22px; border-top: 1px solid oklch(0.28 0.02 265);">
    <div style="font-family: 'JetBrains Mono', monospace; font-size: 12px; color: oklch(0.6 0.01 260);">
      ...
      <a href="/dogrulama/{anketSlug}" style="color: {LIME}; text-decoration: underline;">🔒 sonucu doğrula</a>
    </div>
    <div style="text-align: right; flex-shrink: 0; margin-left: 16px;">
      <div style="font-family: 'JetBrains Mono', monospace; font-size: 10px; letter-spacing: 0.1em; text-transform: uppercase; color: oklch(0.6 0.01 260); margin-bottom: 3px;">Sıradaki oylamaya kalan</div>
